...
git clone [https://github.com/yourusername/fetchstuck.git](https://github.com/yourusername/fetchstuck.git)
cd fetchstuck
...
kitty - For high-quality image display in Kitty terminal.
